    ...
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      <div className="mt-10 grid gap-8 lg:grid-cols-3">
        <div className="lg:col-span-2 space-y-8">
          {/* Description */}
          <section>
            <h2 className="mb-3 text-xl font-semibold text-gray-900">About This Tour</h2>
          ...
          {tour.highlights.length > 0 && (
            <section>
              <h2 className="mb-3 text-xl font-semibold text-gray-900">Highlights</h2>
          ...
          <div className="grid gap-6 sm:grid-cols-2">
            ...
            {tour.exclusions.length > 0 && (
              <section>
                <h2 className="mb-3 text-lg font-semibold text-gray-900">What&apos;s Excluded</h2>
                <ul className="space-y-1">
          ...
          {tour.meeting_point && (
            <section>
              <h2 className="mb-2 text-xl font-semibold text-gray-900">Meeting Point</h2>
          ...
          {tour.cancellation_policy && (
            <section>
              <h2 className="mb-2 text-xl font-semibold text-gray-900">Cancellation Policy</h2>
